...
<div class="harjoitus-paketti">
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v1" data-answer="sanomme">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v2" data-answer="sanon">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v3" data-answer="sanovat">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v7" data-answer="varoa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v8" data-answer="varoa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v9" data-answer="varoo">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v10" data-answer="puhuu">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v11" data-answer="puhumme">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v12" data-answer="puhuvat">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v13" data-answer="nukumme">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v14" data-answer="nukun">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v15" data-answer="nukkuu">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v16" data-answer="rakastuu">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v17" data-answer="rakastumme">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v18" data-answer="muuttuu">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v19" data-answer="muuttuu">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v20" data-answer="sattuu">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v21" data-answer="sattuu">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v22" data-answer="unohtua">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v23" data-answer="unohtuu">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v24" data-answer="pysyä">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v25" data-answer="pysyä">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v26" data-answer="pysy">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v27" data-answer="etsii">Check</button>
    <span id="v27-res" class="palaute"></span>
  </div>
  <div style="margin-bottom: 20px;">
    <p>28. Mitä sinä <input type="text" id="v28" class="finnish-input" placeholder="etsiä"> ?</p>
    <button class="tarkista-btn" data-id="v28" data-answer="etsit">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v29" data-answer="etsimme">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v30" data-answer="mietin">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v31" data-answer="miettii">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v32" data-answer="miettivät">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v33" data-answer="luette">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v34" data-answer="lukee">Check</button>
    <span id="v34-res" class="palaute"></span>
  </div>
  <div style="margin-bottom: 20px;">
    <p>35. Me <input type="text" id="v35" class="finnish-input" placeholder="lukea"> kirjastossa.</p>
    <button class="tarkista-btn" data-id="v35" data-answer="luemme">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v36" data-answer="laskea">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v37" data-answer="laskea">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v38" data-answer="antaa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v39" data-answer="antaa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v40" data-answer="annan">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v41" data-answer="autamme">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v42" data-answer="auttavat">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v43" data-answer="auttaa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v44" data-answer="odottaa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v45" data-answer="odottavat">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v46" data-answer="odotamme">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v47" data-answer="soittaa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v48" data-answer="soittaa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v49" data-answer="soitat">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v50" data-answer="nukahtavat">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v51" data-answer="nukahtaa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v52" data-answer="aloitan">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v53" data-answer="aloittaa">Check</button>
  ...
  <div style="margin-bottom: 20px;">
    ...
    <button class="tarkista-btn" data-id="v54" data-answer="aloittaa">Check</button>
